      ...
      <ScrollArea className="flex-1 p-4">
        <div className="space-y-4">
          {messages.map((msg, idx) => (
            ...
            >
              {msg.role === 'assistant' && (
                <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 animate-float">
              ...
              <div
                ...
                style={{
                  boxShadow: msg.role === 'assistant' ? 'var(--glow-primary)' : 'var(--glow-secondary)',
